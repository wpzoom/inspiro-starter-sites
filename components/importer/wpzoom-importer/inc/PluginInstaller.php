...
class PluginInstaller {
	...
	public function init() {
		...
		add_action( 'wpzi/plugin_intaller_before_plugin_activation', array( $this, 'before_plugin_activation' ) );
		add_action( 'wpzi/plugin_intaller_after_plugin_activation', array( $this, 'after_plugin_activation' ) );

		add_action( 'wp_ajax_wpzi_install_plugin', array( $this, 'install_plugin_callback' ) );
	}
	...
	private function activate_plugin( $plugin_filename, $slug ) {
		Helpers::do_action( 'wpzi/plugin_intaller_before_plugin_activation', $slug );

		$activated = activate_plugin( $plugin_filename );

		Helpers::do_action( 'wpzi/plugin_intaller_after_plugin_activation', $slug );
