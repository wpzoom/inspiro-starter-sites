<?php
/**
 * Class for the import actions used in the WPZOOM Demo Import plugin.
 * Register default WP actions for WPZI plugin.
 *
 * @package wpzi
 */
...
class ImportActions {
	...
	public function register_hooks() {
		...
		add_action( 'wpzi/after_content_import_execution', array( $this, 'redux_import' ), 30, 3 );
