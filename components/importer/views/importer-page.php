...
<div class="iss__admin-notices js-iss-admin-notices-container"></div>
    ...
    <div id="tabs"><!-- #tabs -->
        ...
        <div class="iss-onboard_content-wrapper">
            <div class="iss-onboard_content">
                <div class="iss-onboard_content-main">

					<div id="demo-importer" class="iss-onboard_content-main-tab">
						<div class="theme-info-wrap welcome-section">
							<h3 class="iss-onboard_content-main-title">
								<?php esc_html_e( 'Demo Importer', 'inspiro-starter-sites' ); ?>
							</h3>
							<p class="about">
										...
										<ul>
											...
											<li data-name="<?php echo esc_attr( strtolower( $import_file['import_file_name'] ) ); ?>">
												<figure title="<?php echo esc_attr( $import_file['import_file_name'] ); ?>">
													<div class="preview-thumbnail iss-import" style="background-image:url('<?php echo esc_url( $img_src ) ?>')">
					...
					<div id="premium-demos" class="iss-onboard_content-main-tab iss-onboard_content-main-theme-child">
						<?php require_once INSPIRO_STARTER_SITES_PATH . 'components/importer/views/premium-demos.php'; ?>
					</div><!--/#premium-demos-->

                </div><!--/.iss-onboard_content-main-->
            </div><!--/.iss-onboard_content-->
        </div><!--/.iss-onboard_content-wrapper-->


    </div>
    <?php require_once INSPIRO_STARTER_SITES_PATH . 'components/admin/parts/footer.php'; ?>
</div><!--/.iss-onboard_wrapper-->