		...
		<div class="wpz-onboard_header">
			...
			<div class="wpz-onboard_title-wrapper">
				<h1 class="wpz-onboard_title">
					...
					<?php echo $the_theme->get( 'Name' ); ?>
				</h1>
				<h2 class="wpz-onboard_framework-version">v <?php echo esc_html( $the_theme->get( 'Version' ) ); ?></h2>
			</div>
        ...
        <div class="wpz-onboard_content-wrapper">
            <div class="wpz-onboard_content">
                <div class="wpz-onboard_content-main">
					...
					<div id="premium-demos" class="wpz-onboard_content-main-tab wpz-onboard_content-main-theme-child">
						<?php require_once INSPIRO_TOOLKIT_PATH . 'components/importer/views/premium-demos.php'; ?>
					</div><!--/#premium-demos-->

                </div><!--/.wpz-onboard_content-main-->
            </div><!--/.wwpz-onboard_content-->
        </div><!--/.wpz-onboard_content-wrapper-->


    </div>
    <?php require_once INSPIRO_TOOLKIT_PATH . 'components/admin/parts/footer.php'; ?>
</div><!--/.wpz-onboard_wrapper-->