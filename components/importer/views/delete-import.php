...
<div class="iss iss--delete-imported iss-onboard_wrapper">
		...
		<div class="iss__content-container-content">
			<div class="iss__content-container-content--main">
				<?php if ( isset( $_GET['imported_demo'] ) ) : 
					...
					?>
					<div class="iss-delete-imported-content js-iss-delete-imported-content">
						<div class="iss-delete-imported-content-header">
						...
						<div class="iss-delete-imported-content-footer">
							...
							<a href="#" class="button button-danger js-iss-delete-imported-demo"><?php esc_html_e( 'Delete' , 'inspiro-starter-sites' ); ?></a>
						</div>
					</div>
				<?php endif; ?>

				<div class="iss-deleting js-iss-deleting">
					<div class="iss-deleting-header">
					...
					<div class="iss-deleting-content">
						<img class="iss-deleting-content-deleting" src="<?php echo esc_url( INSPIRO_STARTER_SITES_URL . 'components/importer/assets/images/importing.svg' ); ?>" alt="<?php esc_attr_e( 'Deleting animation', 'inspiro-starter-sites' ); ?>">
					</div>
				</div>

				<div class="iss-deleted js-iss-deleted">
					<div class="iss-deleted-content-header">
						<h2 class="js-iss-ajax-response-title"><?php esc_html_e( 'Demo Content Deleted Successfully' , 'inspiro-starter-sites' ); ?></h2>
					...
					<div class="iss-deleted-content">
						<div class="iss__response js-iss-ajax-complete-response"></div>
					</div>
					<div class="iss-deleted-footer">
						<div class="iss-delete-imported-content-footer">
