...
<div class="iss iss--install-plugins iss-onboard_wrapper">

<div class="iss__admin-notices js-iss-admin-notices-container"></div>

	<div class="iss-onboard_header">
		<!-- Onboard title -->
		<div class="iss-onboard_title-wrapper">
			<h1 class="iss-onboard_title">
			...
			<h2 class="iss-onboard_framework-version">v <?php echo esc_html( INSPIRO_STARTER_SITES_VERSION ); ?></h2>
		</div>
		<ul class="iss-onboard_tabs">
			<li class="iss-onboard_tab iss-onboard_tab-demos ui-tabs-tab ui-corner-top ui-state-default ui-tab ui-tabs-active ui-state-active">
			...
			<li class="iss-onboard_tab iss-onboard_tab-premium-demos">
	...
	<div class="iss__content-container">

		<div class="iss__content-container-content">
			<div class="iss__content-container-content--main">
				<?php if ( isset( $_GET['import'] ) ) : 

					check_admin_referer( 'importer_step' );
					
					?>
					<div class="iss-install-plugins-content js-iss-install-plugins-content">
						<div class="iss-install-plugins-content-header">
						...
						<?php if( ! $is_theme_active ) : ?>
						<div class="iss-install-theme-content">
							<label class="theme-item theme-item-inspiro" for="iss-inspiro-theme">
								<div class="theme-item-content">
									...
									<div class="theme-item-error js-iss-theme-item-error"></div>
									<div class="theme-item-info js-iss-theme-item-info"></div>
								</div>
								<span class="theme-item-checkbox">
									<input type="checkbox" id="iss-inspiro-theme" name="inspiro" <?php checked( $is_theme_recommended ); ?>>
									<span class="checkbox">
										<img src="<?php echo esc_url( INSPIRO_STARTER_SITES_URL . 'components/importer/assets/images/icons/check-solid-white.svg' ); ?>" class="iss-check-icon" alt="<?php esc_attr_e( 'Checkmark icon', 'inspiro-starter-sites' ); ?>">
										<img src="<?php echo esc_url( INSPIRO_STARTER_SITES_URL . 'components/importer/assets/images/loader.svg' ); ?>" class="iss-loading iss-loading-md" alt="<?php esc_attr_e( 'Loading...', 'inspiro-starter-sites' ); ?>">
									</span>
								</span>
							</label>
						</div>
						...
						<div class="iss-install-plugins-content-content">
							<?php if ( empty( $theme_plugins ) ) : ?>
								<div class="iss-content-notice">
									<p>
							...
							<?php else : ?>
								...
								<?php foreach ( $theme_plugins as $plugin ) : ?>
									...
									<label class="plugin-item plugin-item-<?php echo esc_attr( $plugin['slug'] ); ?><?php echo $is_plugin_active ? ' plugin-item--active' : ''; ?><?php echo ! empty( $plugin['required'] ) ? ' plugin-item--required' : ''; ?>" for="iss-<?php echo esc_attr( $plugin['slug'] ); ?>-plugin">
										<div class="plugin-item-content">
											...
											<?php endif; ?>
											<div class="plugin-item-error js-iss-plugin-item-error"></div>
											<div class="plugin-item-info js-iss-plugin-item-info"></div>
										</div>
										<span class="plugin-item-checkbox">
											<input type="checkbox" id="iss-<?php echo esc_attr( $plugin['slug'] ); ?>-plugin" name="<?php echo esc_attr( $plugin['slug'] ); ?>" <?php checked( ! empty( $plugin['preselected'] ) || ! empty( $plugin['required'] ) || $is_plugin_active ); ?><?php disabled( $is_plugin_active ); ?>>
											<span class="checkbox">
												<img src="<?php echo esc_url( INSPIRO_STARTER_SITES_URL . 'components/importer/assets/images/icons/check-solid-white.svg' ); ?>" class="iss-check-icon" alt="<?php esc_attr_e( 'Checkmark icon', 'inspiro-starter-sites' ); ?>">
												<?php if ( ! empty( $plugin['required'] ) ) : ?>
													<img src="<?php echo esc_url( INSPIRO_STARTER_SITES_URL . 'components/importer/assets/images/icons/lock.svg' ); ?>" class="iss-lock-icon" alt="<?php esc_attr_e( 'Lock icon', 'inspiro-starter-sites' ); ?>">
												<?php endif; ?>
												<img src="<?php echo esc_url( INSPIRO_STARTER_SITES_URL . 'components/importer/assets/images/loader.svg' ); ?>" class="iss-loading iss-loading-md" alt="<?php esc_attr_e( 'Loading...', 'inspiro-starter-sites' ); ?>">
											</span>
										</span>
						...
						<div class="iss-install-plugins-content-footer">
							...
							<a href="#" class="button button-primary js-iss-install-plugins-before-import"><?php esc_html_e( 'Install & Import' , 'inspiro-starter-sites' ); ?></a>
						</div>
					</div>
				<?php else : ?>
					<div class="js-iss-auto-start-manual-import"></div>
				<?php endif; ?>

				<div class="iss-importing js-iss-importing">
					<div class="iss-importing-header">
					...
					<div class="iss-importing-content">
						<img class="iss-importing-content-importing" src="<?php echo esc_url( INSPIRO_STARTER_SITES_URL . 'components/importer/assets/images/importing.svg' ); ?>" alt="<?php esc_attr_e( 'Importing animation', 'inspiro-starter-sites' ); ?>">
					</div>
				</div>

				<div class="iss-imported js-iss-imported">
					<div class="iss-imported-header">
						<h2 class="js-iss-ajax-response-title"><?php esc_html_e( 'Demo Content Successfully Imported' , 'inspiro-starter-sites' ); ?></h2>
						<div class="js-iss-ajax-response-subtitle">
							<p>
					...
					<div class="iss-imported-content">
						<div class="iss__response  js-iss-ajax-complete-response"></div>
					</div>
					<div class="iss-imported-footer">
						<?php echo wp_kses(
			...
			<div class="iss__content-container-content--side">
				<?php
