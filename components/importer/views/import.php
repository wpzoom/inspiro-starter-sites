			...
			<div class="wpzi__content-container-content--main">
						...
						<div class="wpzi-install-theme-content">
							<label class="theme-item theme-item-inspiro" for="wpzi-inspiro-theme">
								...
								<span class="theme-item-checkbox">
									...
									<span class="checkbox">
										<img src="<?php echo esc_url( WPZI_URL . 'assets/images/icons/check-solid-white.svg' ); ?>" class="wpzi-check-icon" alt="<?php esc_attr_e( 'Checkmark icon', 'inspiro-starter-sites' ); ?>">
										<img src="<?php echo esc_url( WPZI_URL . 'assets/images/loader.svg' ); ?>" class="wpzi-loading wpzi-loading-md" alt="<?php esc_attr_e( 'Loading...', 'inspiro-starter-sites' ); ?>">
									</span>
								</span>
							</label>
						</div>
										...
										<span class="plugin-item-checkbox">
											...
											<span class="checkbox">
												...
												<?php if ( ! empty( $plugin['required'] ) ) : ?>
													<img src="<?php echo esc_url( WPZI_URL . 'assets/images/icons/lock.svg' ); ?>" class="wpzi-lock-icon" alt="<?php esc_attr_e( 'Lock icon', 'inspiro-starter-sites' ); ?>">
												<?php endif; ?>
												<img src="<?php echo esc_url( WPZI_URL . 'assets/images/loader.svg' ); ?>" class="wpzi-loading wpzi-loading-md" alt="<?php esc_attr_e( 'Loading...', 'inspiro-starter-sites' ); ?>">
											</span>
										</span>
				...
				<div class="wpzi-importing js-wpzi-importing">
					...
					<div class="wpzi-importing-content">
						<img class="wpzi-importing-content-importing" src="<?php echo esc_url( WPZI_URL . 'assets/images/importing.svg' ); ?>" alt="<?php esc_attr_e( 'Importing animation', 'inspiro-starter-sites' ); ?>">
					</div>
				</div>

				<div class="wpzi-imported js-wpzi-imported">
					<div class="wpzi-imported-header">
						<h2 class="js-wpzi-ajax-response-title"><?php esc_html_e( 'Demo Content Successfully Imported' , 'inspiro-starter-sites' ); ?></h2>
