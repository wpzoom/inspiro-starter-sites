<?php
/**
 * Class for declaring the content importer used in the Inspiro\Starter_Sites Importer
 *
...
class Importer {
	...
	/**
	 * The instance of the Inspiro\Starter_Sites\Logger class.
	 *
	 * @var object
	 */
	public $logger;
	...
	private function include_required_files() {
		...
		// Include the WordPress Importer v2 class.
